...
pub(crate) fn help_lines() -> Vec<Line<'static>> {
    vec![
        ...
        Line::from("  e       Open embedded terminal for selected session/task"),
        Line::from("  i       Interact with focused terminal pane"),
        Line::from("  z       Cycle terminal layout (docked/workspace/focus)"),
        Line::from("  f       Toggle terminal follow mode"),
        ...
        Line::from("  g / G   Jump terminal/log to top or bottom"),
        Line::from("  [ / ]   Jump between review/cleanup task cards"),
        Line::from("  t       Start next task card"),
        Line::from("  R       Generate team report"),
        Line::from("  r       Refresh review / Refresh log / Refresh terminal"),
        Line::from("  PgUp/Dn Scroll terminal or log output"),
